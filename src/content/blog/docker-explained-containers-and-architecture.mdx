...
- **No Guest Kernel:** Docker images do _not_ include a kernel. They only package the User Space (e.g., the Alpine or Ubuntu file system). When the container runs, it hooks directly into the host machine's existing Linux Kernel.
