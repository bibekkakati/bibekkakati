                        ...
                        {DATA.education.map((education, index) => (
                            ...
                            >
                                <a
                                    ...
                                    className="flex items-start md:items-center gap-x-3 justify-between group"
                                >
                                    {education.logoUrl ? (
                                        <img
                ...
                <div className="flex min-h-0 flex-col gap-y-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {DATA.skills.map((skill, id) => (
                            ...
                            >
                                <div className="border bg-background border-border ring-2 ring-border/20 rounded-xl h-8 w-fit px-3 md:px-4 flex items-center gap-2">
                                    {skill.icon && (
